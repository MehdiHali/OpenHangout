...
public class HomeApiService {
	...
	public Response authenticationService(InputStream credentials) {
		...
		User user = new User();
		String token="";
		System.out.println("READING CREDENTIALS AND MAPPING THEM TO USER OBJECT... ");
	...
	public String authenticate(User user)	{
		...
		System.out.println("CALLING ISSUE TOKEN");
	...
	@Path("/users/user")
	@Produces(MediaType.TEXT_PLAIN)
	public Response getAuthtenticatedUser(ContainerRequestContext req) {
